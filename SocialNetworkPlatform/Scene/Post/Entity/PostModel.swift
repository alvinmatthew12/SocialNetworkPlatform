...
internal struct PostModel: Codable {
    ...
    internal init(id: UUID = UUID(), post: String, postImageName: String?, userID: Int16, createdAt: Date = Date()) {
